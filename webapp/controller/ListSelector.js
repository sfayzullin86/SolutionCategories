sap.ui.define([
	...
	return BaseObject.extend("SolutionCategories.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias SolutionCategories.model.ListSelector
		 */
		 ...
		 * @return {SolutionCategories.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
