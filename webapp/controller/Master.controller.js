/*global history */
sap.ui.define([
	"SolutionCategories/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"SolutionCategories/model/formatter",
	"sap/m/MessageBox"
], function(BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, MessageBox) {
	"use strict";

	return BaseController.extend("SolutionCategories.controller.Master", {
				...
				function(mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							SolcatId: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("SolcatId"))
						}, true);
					}
				}.bind(this),
				function(mParams) {
		...
		_showDetail: function(oItem) {
			...
			this.getRouter().navTo("object", {
				SolcatId: encodeURIComponent(oItem.getBindingContext().getProperty("SolcatId"))
			}, bReplace);
		},
