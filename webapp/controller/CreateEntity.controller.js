sap.ui.define([
	...
	return BaseController.extend("SolutionCategories.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("SOLCATSet", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("SOLCATSet", oData);
