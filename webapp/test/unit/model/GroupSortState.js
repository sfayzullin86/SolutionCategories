sap.ui.define([
	"SolutionCategories/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function(assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("SolcatTxt").length, 1, "The sorting by SolcatTxt returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by SolcatTxt and there was a grouping before", function(assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("SolcatTxt");
