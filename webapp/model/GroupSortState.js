sap.ui.define([
	...
	return BaseObject.extend("SolutionCategories.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias SolutionCategories.model.GroupSortState
		 */
		...
		group: function(sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "SolcatTxt");
			}
